...
\includegraphics[trim = 0mm 5mm 5mm 0mm, clip, width=3.3in]{fig1_a.eps}			% Mosresid.eps
\includegraphics[trim = 0mm 5mm 5mm 10mm, clip, width=3.3in]{fig1_b.eps}		% MOSphotqual.eps
...
\begin{figure*} \centering
\includegraphics[trim = 0mm 5mm 5mm 50mm, clip, width=3.3in]{fig2_a.eps}		% NFMresid.eps
\includegraphics[trim = 0mm 5mm 5mm 50mm, clip, width=3.3in]{fig2_b.eps}		% NFMphotqual.eps
...
\begin{figure*} \centering
\includegraphics[trim = 0mm 7mm 5mm 5mm, clip, width=6in]{fig3.eps}		% finalphot.eps
...
\begin{figure} \centering
\includegraphics[trim = 0mm 62mm 5mm 5mm, clip, width=3.3in]{fig4.eps}		% isointerp.eps
...
\begin{figure*} \centering
\includegraphics[trim = 0mm 30mm 5mm 5mm, clip, width=6in]{fig5.eps}		% isocompare.eps
...
\begin{figure*} \centering
\includegraphics[trim = 0mm 5mm 5mm 0mm, clip, width=4.5in]{fig6.eps}		% isocompare-zoomed.eps
